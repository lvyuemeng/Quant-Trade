...
#         """
#         return self.provider.stock_universe(trade_date)
...
#         """
#         return self.provider.daily_market(symbol, start_date, end_date, adjust)
...
#         """
#         return self.provider.quarterly_income_statement(report_date)
...
#         Returns a per-stock table keyed by (ts_code, announcement_date).
#         """
#         return self.provider.quarterly_balance_sheet(report_date)
...
#         Returns a per-stock table keyed by (ts_code, announcement_date).
#         """
#         return self.provider.quarterly_cashflow_statement(report_date)
...
#         """
#         return self.provider.quarterly_fundamentals(report_date)
...
#         range when possible.
#         """
#         return self.provider.northbound_flow(start_date, end_date)
...
#         return self.provider.industry_classification(
...
#         return self.provider.margin_balance(start_date, end_date)
...
#         """
#         return self.provider.fundamental_data(symbol)
